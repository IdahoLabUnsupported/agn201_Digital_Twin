...
namespace Microsoft.MixedReality.OpenXR
{
    ...
    public class AppRemoting : MonoBehaviour
    {
        ...
        private void Update()
        {
                ...
                if (m_connectionState != connectionState || disconnectReason != m_disconnectReason)
                {
                    ...
                    switch (m_connectionState)
                    {
                        case Remoting.ConnectionState.Connected:
                            ...
                            HideConnection2DUI();
                            // Start QR code (once compatibility is verified, qr code tracking auto-starts)
                            //QRCodeManager.GetComponent<QRCodesManager>().checkQRCompatibility();
            ...
            string commonMessage = $"Welcome to the {ProjectName} mixed reality dashboard for streaming. Provide an IP address from your Holographic Remoting Player and click \"Connect\". \nEnsure that the Hololens and the streaming computer are connected to the same network.";
            ...
            string listenMessage = m_connectionState == Remoting.ConnectionState.Connected
                            ...
                            : m_connectionState == Remoting.ConnectionState.Disconnected && m_disconnectedOnListenMode
                                ...
                                : $"Listening to incoming connection on {hostIp}:{listenPort}. ConnectPort is {connectPort}";
